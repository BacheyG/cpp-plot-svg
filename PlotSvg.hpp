...
public:
	...
	void addPolygon(const std::vector<VECTOR2D> vertices, const std::vector<int> indices, bool triangulatedIndices = true, const std::string& fillColor = "#00000000", const std::string& strokeColor = "#000000", float strokeWidth = 1, bool animated = false);
